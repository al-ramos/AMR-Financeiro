...
/// <summary>
/// Plano de contas padrão (modelo CFC) para o plano gerencial novo (planodecontas).
/// Somente níveis 1 a 3 — níveis 4 e 5 são criados pela empresa conforme sua estrutura;
/// por isso nenhuma conta do seed aceita lançamentos (só nível 5 aceita).
///
/// Não roda no startup: é acionado sob demanda via POST /api/plano-contas/seed.
...
public static class PlanoContasSeeder
{
    ...
    [
        ...
        // (GrupoDRE em contas sintéticas é apenas classificatório — a DRE soma só nível 5)
        ...
        new("3.1.1", "3.1", "Receita de Produtos", TipoContaContabil.Receita, NaturezaConta.Credora, 3, GrupoDRE.ReceitaBruta),
        new("3.1.2", "3.1", "Receita de Serviços", TipoContaContabil.Receita, NaturezaConta.Credora, 3, GrupoDRE.ReceitaBruta),
        new("3.2.1", "3.2", "ICMS sobre Vendas", TipoContaContabil.Imposto, NaturezaConta.Devedora, 3, GrupoDRE.DeducoesReceita),
        new("3.2.2", "3.2", "PIS/COFINS", TipoContaContabil.Imposto, NaturezaConta.Devedora, 3, GrupoDRE.DeducoesReceita),
        new("3.2.3", "3.2", "Devoluções e Abatimentos", TipoContaContabil.Despesa, NaturezaConta.Devedora, 3, GrupoDRE.DeducoesReceita),
        new("4.1.1", "4.1", "Custo dos Produtos Vendidos", TipoContaContabil.Custo, NaturezaConta.Devedora, 3, GrupoDRE.CustoMercadorias),
        new("4.1.2", "4.1", "Custo dos Serviços Prestados", TipoContaContabil.Custo, NaturezaConta.Devedora, 3, GrupoDRE.CustoMercadorias),
        new("5.1.1", "5.1", "Salários Comerciais", TipoContaContabil.Despesa, NaturezaConta.Devedora, 3, GrupoDRE.DespesasOperacionais),
        new("5.1.2", "5.1", "Comissões", TipoContaContabil.Despesa, NaturezaConta.Devedora, 3, GrupoDRE.DespesasOperacionais),
        new("5.2.1", "5.2", "Salários Administrativos", TipoContaContabil.Despesa, NaturezaConta.Devedora, 3, GrupoDRE.DespesasOperacionais),
        new("5.2.2", "5.2", "Aluguel", TipoContaContabil.Despesa, NaturezaConta.Devedora, 3, GrupoDRE.DespesasOperacionais),
        new("5.2.3", "5.2", "Energia e Utilities", TipoContaContabil.Despesa, NaturezaConta.Devedora, 3, GrupoDRE.DespesasOperacionais),
        new("5.2.4", "5.2", "Depreciação", TipoContaContabil.Despesa, NaturezaConta.Devedora, 3, GrupoDRE.DespesasOperacionais),
        new("6.1.1", "6.1", "Juros Recebidos", TipoContaContabil.OutrasReceitas, NaturezaConta.Credora, 3, GrupoDRE.ReceitasFinanceiras),
        new("6.1.2", "6.1", "Rendimentos de Aplicações", TipoContaContabil.OutrasReceitas, NaturezaConta.Credora, 3, GrupoDRE.ReceitasFinanceiras),
        new("6.2.1", "6.2", "Juros Pagos", TipoContaContabil.OutrasDespesas, NaturezaConta.Devedora, 3, GrupoDRE.DespesasFinanceiras),
        new("6.2.2", "6.2", "IOF e Tarifas Bancárias", TipoContaContabil.OutrasDespesas, NaturezaConta.Devedora, 3, GrupoDRE.DespesasFinanceiras),
        new("6.3.1", "6.3", "IRPJ", TipoContaContabil.Imposto, NaturezaConta.Devedora, 3, GrupoDRE.ImpostosRenda),
        new("6.3.2", "6.3", "CSLL", TipoContaContabil.Imposto, NaturezaConta.Devedora, 3, GrupoDRE.ImpostosRenda),
    ];
        ...
        foreach (var nivel in new[] { 1, 2, 3 })
        {
            foreach (var def in ContasPadrao.Where(d => d.Nivel == nivel))
            {
                ...
                var conta = new PlanoDeContas(
                    ...
                    def.Nivel, paiId, def.Grupo, ordemAtual);
